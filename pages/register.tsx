...
import { AiOutlineEyeInvisible, AiOutlineEye, AiFillApple } from 'react-icons/ai'
    ...
    <div className='register_full'>
        <div className='register_container'>
          <div className='register_form'>
            ...
            <form>
              <input type='text' placeholder='Tên đăng nhập hoặc Email' id='register_username' />
              <div className='register_eyes'>
                <input type={ showPassword ? 'text' : 'password' } placeholder='Mật khẩu' id='register_password'/>
            ...
            <div className="register_forgot">
              <a href="/forgot" id="register_forgot">Quên mật khẩu</a>
            </div>
            <hr />
            <div id="or">hoặc</div>
            <div id="register_methods">
              <button id='register_facebook'>
                <BsFacebook color="blue" size="32px" style={{ paddingTop: '0.25rem' }}/>
            ...
            <div className="register_supports">
              Bạn mới biết đến{" "}
              <a href="/" id="register_home">T&N SHOP?</a>
              <a href="/register" id='register_noAccount'>Đăng ký</a>
            </div>
          </div>
        </div>
      </div>
