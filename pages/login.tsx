      ...
      <div className='login_full'>
        <div className='login_container'>
          <div className='login_form'>
            ...
            <form>
              <input type='text' placeholder='Tên đăng nhập hoặc Email' id='login_username' />
              <div className='login_eyes'>
                <input type={ showPassword ? 'text' : 'password' } placeholder='Mật khẩu' id='login_password'/>
            ...
            <div className="login_forgot">
              <a href="/forgot" id="login_forgot">Quên mật khẩu</a>
            </div>
            <hr />
            <div id="or">hoặc</div>
            ...
            <div className="login_supports">
              Bạn mới biết đến{" "}
              <a href="/" id="login_home">T&N SHOP?</a>
              <a href="/register" id='login_noAccount'>Đăng ký</a>
            </div>
          </div>
        </div>
      </div>
