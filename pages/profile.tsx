        ...
        <div className="profile_info">
          ...
          <div className="profile_right">
            ...
            <div className='profile_changePassword'>
              <BiLock size={25} style={{ marginRight:'15px',paddingLeft:'5px' }}/>
              Đổi mật khẩu
              <button className='profile_update' style={{ marginLeft:'140px' }}>Cập nhật</button>
            </div>
            <div className='profile_changePassword'>
              <BsShieldLock size={25} style={{ marginRight:'15px',paddingLeft:'5px' }}/>
              Thiết lập mã PIN
              <button className='profile_update' style={{ marginLeft:'118px' }}>Cập nhật</button>
            </div>

            <p className='profile_title'>Liên kết mạng xã hội</p>
            <div className='profile_changePassword'>
              <BsFacebook color="blue" size={25} style={{ marginRight:'15px',paddingLeft:'5px' }}/>
              Facebook
              <button className='profile_update' style={{ marginLeft:'166px' }}>Cập nhật</button>
            </div>
            <div className='profile_changePassword'>
              <FcGoogle size={25} style={{ marginRight:'15px',paddingLeft:'5px' }}/>
              Google
              <button className='profile_update' style={{ marginLeft:'181px' }}>Cập nhật</button>
            </div>
          </div>
        </div>
      </div>
